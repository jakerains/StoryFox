    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-3">
          <ThemeToggle />
          {/* Compact icon-only download button for mobile */}
          <a
            href="https://github.com/jakerains/StoryFox/releases/latest"
            className="flex h-9 w-9 items-center justify-center rounded-full bg-sj-coral text-white transition-colors hover:bg-sj-coral-hover sm:hidden"
            aria-label="Download StoryFox"
          >
            <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
